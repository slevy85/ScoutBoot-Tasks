...
import org.eclipse.scout.boot.tasks.commons.ui.admin.user.OptionsForm.MainBox.ApplyButton;
import org.eclipse.scout.boot.tasks.commons.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox;
import org.eclipse.scout.boot.tasks.commons.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.CancelPasswordChangeLink;
import org.eclipse.scout.boot.tasks.commons.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.ChangePasswordLink;
import org.eclipse.scout.boot.tasks.commons.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.ConfirmPasswordField;
import org.eclipse.scout.boot.tasks.commons.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.NewPasswordField;
import org.eclipse.scout.boot.tasks.commons.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.OldPasswordField;
import org.eclipse.scout.boot.tasks.commons.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.UpdateLinkButton;
import org.eclipse.scout.boot.tasks.commons.ui.admin.user.OptionsForm.MainBox.UserBox;
...
public class OptionsForm extends AbstractForm {
	...
	public OptionsForm() {
		super();
		setUserId(TasksClientSession.get().getUserId());
	}
